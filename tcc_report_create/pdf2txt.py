...
def maketheparser():
    ...
    parser.add_argument("-p", "--pagenos", type=str,
                        help="Comma-separated list of page numbers to parse. Included for legacy applications,\
                         use --page-numbers for more idiomatic argument entry.")
    parser.add_argument("--page-numbers", type=int, default=None, nargs="+",
                        help="Alternative to --pagenos with space-separated numbers;\
                         supercedes --pagenos where it is used.")
    ...
    parser.add_argument("-t", "--output_type", type=str, default="text",
